...
import Admin_Home from '../Page/Parent_Home';
...
import { CalendarMonth, Grade } from '@mui/icons-material';
              ...
              <ul>
                <li>
                  <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '15px', marginLeft: "25px", marginTop:'5px'}}>
                    ...
                    <Link className="list-title" to="/Family/"><HomeIcon /> Home</Link>
                  </div>
                </li>
                ...
                <li>
                  <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '15px', marginLeft: "25px", marginTop:'5px'}}>
                    ...
                    <Link className="list-title" to="/Family/Message"> <Message /> Message</Link>
                  </div>
                </li>
                <li>
                  <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '15px', marginLeft: "25px", marginTop:'5px'}}>
                    
                    <Link className="list-title" to="/Family/Payment"><Payment /> Payment</Link>
                  </div>
                </li>
                <li>
                  <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '15px', marginLeft: "25px", marginTop:'5px'}}>
                    
                    <Link className="list-title" to="/Family/Announcement"><Announcement /> Announcement</Link>
                  </div>
                </li>
                <li>
                  <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '15px', marginLeft: "25px", marginTop:'5px'}}>
                    
                    <Link className="list-title" to="/Family/Attendance"><CalendarMonth /> Attendance</Link>
                  </div>
                </li>
                <li>
                  <div style={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'center', gap: '15px', marginLeft: "25px", marginTop:'5px'}}>
                    
                    <Link className="list-title" to="/Family/Grade"><Grade /> Grade</Link>
                  </div>
                </li>
              </ul>
            </nav>
              ...
              <nav className="menu" >
                <ul className="last">
                  <li>
                    ...
                    <Link className="list-title" to="/Family/Profile"> <SettingProfile /> Profile</Link>
                  </li>

                  <li>
                  
                    <Link className="list-title" to="/Family/Setting"><SettingsIcon /> Setting</Link>
                  </li>

                  <li>
                   
                    <Link className="list-title" to="/Family/Logout"><Logout />  Logout</Link>
                  </li>
